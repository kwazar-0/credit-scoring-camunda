...
Согласовано с **[git-workflow.md](git-workflow.md)** и **[github-setup.md](github-setup.md)**. Шаблоны `feature/*`, `hotfix/*`, `release/*` создаются по мере работы и не обязаны существовать постоянно на `origin`.
