...
Aligned with [main.md](main.md) (entry), [gcp-saas-access-matrix-11x6.md](gcp-saas-access-matrix-11x6.md) (roles), **[github-setup.md](github-setup.md)**, and **[branch-notes.md](branch-notes.md)**. Default remote: `git@github.com:kwazar-0/credit-scoring-camunda.git`. Repository name, tags, and clone path: **[naming.md](naming.md)**.
