# Handlowy Bank Galicyjski (HBG) — — handoff context
...
- **§1–5, §7–8** (in the RU file): product, layout, **phase plan**, E2E.
- **§9+**: extended enterprise / VPC / GKE / compliance — read **after** the infra MVP, align with Pulumi and policy.
- **Region:** `europe-central2` (Warsaw) for data.
