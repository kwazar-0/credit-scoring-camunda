...
| **Связь** | [hbg-rag-dominance](/hbg-rag-dominance) — стратегия и роли U1–U6 |
...
В документе описаны **четыре** открытые позиции; **шесть** функциональных слотов (U1–U6) из [hbg-rag-dominance](/hbg-rag-dominance) закрываются так:
...
Использовать **корпоративные** идентификаторы; не публиковать личные почты в репозитории. Плейсхолдеры заменить при внедрении. См. также [gcp-saas-access-matrix-11x6](/gcp-saas-access-matrix-11x6) и [infra-pulumi-iac](/infra-pulumi-iac).
