...
**Cel:** katalog [`infra/pulumi/gke-infra/`](https://github.com/kwazar-0/credit-scoring-camunda/tree/develop/infra/pulumi/gke-infra) to **osobny** projekt Pulumi (własny `Pulumi.yaml`) — nie mylić z głównym [`infra/pulumi/`](https://github.com/kwazar-0/credit-scoring-camunda/tree/develop/infra/pulumi). Program [__main__.py](https://github.com/kwazar-0/credit-scoring-camunda/blob/develop/infra/pulumi/gke-infra/__main__.py) tworzy **VPC + PSA**, **Artifact Registry**, bucket **GCS** (wersjonowanie), **prywatny** **Cloud SQL (PostgreSQL 15)** (bez publicznego IPv4) oraz **regionalny** klaster **GKE** w **europe-central2** (domyślnie; `gcp:region`).
...
**Specyfikacja (EN, pełna):** [infra-pulumi-gke-sandbox →](/en/infra-pulumi-gke-sandbox) · **RU:** [→](/ru/infra-pulumi-gke-sandbox) · w repo: [`README.md`](https://github.com/kwazar-0/credit-scoring-camunda/blob/develop/infra/pulumi/gke-infra/README.md).
