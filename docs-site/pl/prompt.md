# Handlowy Bank Galicyjski (HBG) — — kontekst handoff
...
- **§1–5, §7–8** (w wersji RU): produkt, układ repozytorium, **fazy planu**, E2E.
- **§9+:** rozbudowana spec enterprise (VPC, GKE, compliance) — czytaj **po** MVP infrastruktury, zgodnie z Pulumi i polityką.
- **Region danych:** `europe-central2` (Warszawa).
