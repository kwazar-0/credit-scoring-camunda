...
Согласовано с [main.md](main.md) (вход), [gcp-saas-access-matrix-11x6.md](gcp-saas-access-matrix-11x6.md) (роли), **[github-setup.md](github-setup.md)** и **[branch-notes.md](branch-notes.md)**. Remote по умолчанию: `git@github.com:kwazar-0/credit-scoring-camunda.git`. Имена репозитория, тегов и папки клона: **[naming.md](naming.md)**.
...
CI: **`.github/workflows/ci.yml`** — push на **`develop`**, **`main`**, **`release/**`, **`feature/**`, **`hotfix/**`, теги `v*`; PR в **`develop`**, **`main`**, **`release/**` OIDC/WIF — см. [infra-pulumi-iac.md](infra-pulumi-iac.md).

---

## 5. Настройки на GitHub

Пошагово: **[github-setup.md](github-setup.md)**. Кратко: **branch protection** на **`main`** и **`develop`**, **Environments**, **CODEOWNERS**.
