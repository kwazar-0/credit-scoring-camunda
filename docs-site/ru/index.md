...
**HBG Credit Scoring** — это проект автоматизации кредитного конвейера, где процесс принятия решения построен как инженерная система с явным контролем и аудитом.  
В основе — связка **Camunda 8 (BPMN/DMN)** + **FastAPI** + **GKE/Pulumi**.
...
- **Оркестрация вместо ad-hoc** — кредитный процесс явный и аудитопригодный (BPMN/DMN).
