...
**`Credit-Scoring-V2`** не используем как «официальное» имя продукта — это устаревший технический ярлык. Публичное имя контура: **Handlowy Bank Galicyjski (HBG)** (см. `prompt.md`).
